...
const Enjoy = () => {
  return (
    <section className="wrapper pl-[6.25rem] w-[85rem] h-[40.25rem] rounded-[2.5rem] bg-[url('/image/img-hero.svg')] mt-5  bg-cover bg-center flex flex-col gap-10 justify-center items-start">
